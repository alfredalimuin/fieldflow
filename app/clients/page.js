      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, padding: '28px 32px', overflowY: 'auto' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '10px', boxShadow: '0 1px 3px rgba(0,0,0,0.07)' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 140px 120px 140px 160px', padding: '12px 20px', borderBottom: '1px solid #f1f5f9' }}>
            ...
            {loading ? (
              ...
              return (
                <div key={c.id} style={{ display: 'grid', gridTemplateColumns: '1fr 140px 120px 140px 160px', alignItems: 'center', padding: '14px 20px', borderBottom: '1px solid #f8fafc', gap: '8px' }}>
                  <div>
